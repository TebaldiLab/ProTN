...
list.of.packages <- c("geomnet","proBatch", "PhosR")
new.packages <- list.of.packages[!(list.of.packages %in% installed.packages()[,"Package"])]
if(length(new.packages)) {
...
p = callr::r_bg(
    func = function(g, pval_fdr_enrich, pval_enrich_thr) {
      source("functions_2021.R")
      enrichRfnc_universe(g, pval_fdr_enrich, pval_enrich_thr, overlap_size_enrich_thr)
    },
    args = list(unique(psm_anno_df$symbol), pval_fdr_enrich, pval_enrich_thr),
    stdout = "|",
    stderr = "|",
