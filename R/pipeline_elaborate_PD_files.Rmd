...
## 0.2 Summary of input parameters and thresholds
...
cat("Two MDSs are created, one based on the corrected protein abundances, tab **Proteins**. The second on the corrected peptide abundances, tab **Peptides** \n")
cat(" \n \n")
...
#### 1.4. Distributions of normalized abundancies
...
if(p$is_alive() | is.null(p$get_result())){
  ...
  writexl::write_xlsx((enr_df_universe %>% dplyr::filter(Significtive == "TRUE",
                                                         overlap_size>=overlap_size_enrich_thr)),
