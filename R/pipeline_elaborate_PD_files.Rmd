...
df_stat <- data.frame("number" = c(length(unique(psm_anno_df$symbol)), nrow(psm_anno_df)), row.names = c("Discovered proteins by the experiment:", "Discovered peptides by the experiment:"))
kable(df_stat)
```
