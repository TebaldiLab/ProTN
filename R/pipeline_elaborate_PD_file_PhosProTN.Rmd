...
if(deps_pep_l_df %>% dplyr::filter(class!="=") %>% nrow() > 0){
  ...
  for(comp in unique(deps_pep_l_df$comp)){
    ...
    # input_df[[col]]<--log10(input_df[[col]])
    a <- list()
...
if(length(enrich_filter_DBs) > 0){
  ...
  tryCatch({
    ...
    for(db in names(plotlist)){
      ...
      # suppressWarnings(print(plotlist[[db]]))
      cat(" \n \n")
    }
    cat(" \n \n")
    name_list<-vector()
...
if(length(enrich_filter_DBs) > 0){
  ...
  tryCatch({
    ...
    # suppressWarnings(in_tabs(plotlist2, labels = names(plotlist2), level = 4L))
    cat(" \n \n")
    name_list<-vector()
    for(db in names(plotlist2)){
...
if(length(enrich_filter_term) > 0){
  ...
  tryCatch({
    ...
    for(db in names(plotlist3)){
      ...
      # suppressWarnings(print(plotlist3[[db]]))
      cat(" \n \n")
    }
    # suppressWarnings(in_tabs(plotlist3, labels = names(plotlist3), level = 4L))
    cat(" \n \n")
    name_list<-vector()
    for(db in names(plotlist3)){
...
if(length(enrich_filter_term) > 0){
  ...
  tryCatch({
    ...
    for(db in names(plotlist4)){
      ...
      # suppressWarnings(print(plotlist4[[db]]))
      cat(" \n \n")
    }
    # suppressWarnings(in_tabs(plotlist4, labels = names(plotlist4), level = 4L))
    cat(" \n \n")
    name_list<-vector()
    for(db in names(plotlist4)){
...
if(length(enrich_filter_DBs) > 0){
  ...
  tryCatch({
    ...
    for(db in names(plotlist2)){
      ...
      # suppressWarnings(print(plotlist2[[db]]))
      cat(" \n \n")
    }
    # suppressWarnings(in_tabs(plotlist2, labels = names(plotlist2), level = 4L))
    cat(" \n \n")
